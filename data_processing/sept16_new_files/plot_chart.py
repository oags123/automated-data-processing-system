...
def plot_chart3(df_filtered, interval):
    """
    Plot candlestick chart with quantile regression lines.
    ...
    # Define output path
    output_dir = '/home/devuser/algo_trading/public_charts'
    os.makedirs(output_dir, exist_ok=True)

    # Define filename (without timestamp)
    filename = f'BTCUSDT_{interval}_QR_chart.png'
    filepath = os.path.join(output_dir, filename)

    # If file exists, overwrite it automatically
